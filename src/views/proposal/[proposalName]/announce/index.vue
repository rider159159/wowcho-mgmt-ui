  ...
  <section class="py-6">
    ...
    <div class="md:(max-w-324 mx-auto) flex flex-col justify-center">
      <div class="w-full flex justify-end mb-10">
        <RouterLink :to="`/${route.params.proposal}/announce/new`" class="flex justify-center bg-brand-1 text-white hover:bg-brand-2 duration-300 py-2 px-4 rounded-3xl">新增公告</RouterLink>
      </div>
            ...
            <tr v-for="item in data.list" :key="item.id" class="cursor-pointer text-gray-1 rounded-l-lg duration-300 hover:bg-brand-4 text-center">
              ...
              <td>
                <div class="flex justify-center items-center py-2">
                  <RouterLink :to="`/${route.params.proposal}/announce/${item.id}/edit`" class="text-brand2 b-2 b-brand2 hover:bg-brand-1 hover:b-brand-1 hover:text-white duration-300 rounded-8px cursor-pointer px-4 py-2 items-center mr-4" >編輯</RouterLink>
