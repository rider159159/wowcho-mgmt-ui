    ...
    <nav
      ...
      <div class="flex w-full flex-wrap items-center justify-between px-6">
        <div
          ...
          <img @click="router.push('/')" class="cursor-pointer max-w-[calc(100vw-150px)]" src="/logo.svg">
          <ul
            ...
            <li  v-if="isLogin" ref="loginMenuRef" class="cursor-pointer relative">
              <!-- 使用者預設頭像 -->
              <svg v-if="USER_INFO_REF.businessImage == ''" @click="showMemberMenu = !showMemberMenu" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <li v-if="showProposalMenu" class="mb-8">
                ...
                <ul class="mt-3 ml-4">
                  <li class="mb-2">
                    <router-link
                      @click="closeMenu"
                      :to="`/${route.params.proposal}/dashboard`"
                      class="block transition duration-150 ease-in-out hover:text-neutral-700 focus:text-neutral-700 py-2"
                    >
                  ...
                  <li class="mb-2">
                    ...
                    <router-link
                      class="block transition duration-150 ease-in-out hover:text-neutral-700 focus:text-neutral-700 py-2"
                      :to="`/${route.params.proposal}/options`"
                      @click="closeMenu"
                    >
                      <!-- <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <li class="mb-2">
                    ...
                    <router-link
                      class="block transition duration-150 ease-in-out hover:text-neutral-700 focus:text-neutral-700 py-2"
                      :to="`/${route.params.proposal}/announce`"
                      @click="closeMenu"
                    >
                      公告管理
                    </router-link>
                  ...
                  <li class="mb-2">
                    <router-link
                      class="block transition duration-150 ease-in-out hover:text-neutral-700 focus:text-neutral-700 py-2"
                      :to="`/${route.params.proposal}/backers`"
                      @click="closeMenu"
                    >
                      <!-- <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
