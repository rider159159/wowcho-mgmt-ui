...
<template>
  <div class="fixed z-0 flex flex-col lg:flex-row lg:items-center lg:justify-between left-0 bottom-0 lg:h-80px b-t-line b-t-2 w-100vw bg-white px-6 py-4 lg:px-10">
